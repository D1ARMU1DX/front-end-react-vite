            ...
            <Row className='header-box d-flex align-items-center pt-lg-5'>
              <Col lg="6">
                <h1 className='mb-4 animate__animated animate__fadeInUp animate__delay-1s'>
                  Temukan Talenta<br /> <span> dan Bakatmu </span> <br /> Bersama Kami!
                </h1>
                <p className='mb-4 animate__animated animate__fadeInUp animate__delay-1s'>Membantu ribuan member menemukan passion dan kemampuannya.</p>
                ...
                <button className='btn btn-outline-danger btn-lg rounded-1 me-2 mb-xs-0 mb-2 animate__animated animate__fadeInUp animate__delay-1s'>Free Trial</button>
              </Col>
              <Col lg="6" className='pt-lg-0 pt-5'>
                <img src={Stonks} alt="hero-img" className='animate__animated animate__fadeInUp rounded'/>
              </Col>
            </Row>
          </Container>
        </header>
